...
function AboutMe() {
  return (
    ...
    >
      ...
      <div className="col-span-12 flex flex-col items-center md:flex-row gap-10 mt-5 px-5 md:px-0 justify-around">
        <div>
          <img src={star} alt="" />
          <div className="-mt-20">
            <img
              ...
              className="rounded-xl shadow-lg transition-transform duration-500 ease-out hover:scale-105 hover:rotate-1 hover:shadow-[0_12px_40px_rgba(254,178,115,0.4)]"
              width="350"
              height="467"
              loading="lazy"
            />
        ...
        <div className="text-left md:mt-20 flex flex-col gap-5 justify-between md:w-[40%]">
